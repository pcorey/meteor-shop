...
(function() {
  (function(p) {
    ...
    (function(p) {
      ...
      a.a = (function() {
        ...
        return {
          ...
          Qb: function(b, c) {
            ...
            if (0 < g.length) {
              for (
                var d = g[0], e = d.parentNode, m = 0, f = c.length;
                m < f;
                m++
              )
          ...
          Rb: function(a, b) {
            ...
            if (7 >= g)
              try {
                a.mergeAttributes(
                  w.createElement("<input name='" + a.name + "'/>"),
                  !1
                );
              } catch (c) {}
          },
          ...
          Db: function(b, c) {
            for (
              var g = a.a
                  .O(b.getElementsByTagName("input"))
          ...
          yc: function(b) {
            return "string" == typeof b && (b = a.a.ib(b))
              ? E && E.parse ? E.parse(b) : new Function("return " + b)()
              : null;
          },
          jb: function(b, c, g) {
            if (!E || !E.stringify)
      ...
      (function() {
        a.a.ca = function(b, d) {
          ...
          if (u)
            ...
            for (
              "function" == typeof c.innerShiv
                ? e.appendChild(c.innerShiv(k))
                : (e.innerHTML = k);
              f[0]--;
      ...
      var z = {
        ...
        Za: function(b) {
          var d = this,
            ...
            k;
          d.ta ||
            ((d.ta = d.notifySubscribers),
            (d.notifySubscribers = function(a, b) {
              b && "change" !== b
                ? "beforeChange" === b ? d.pb(a) : d.ta(a, b)
                : d.qb(a);
            }));
          var h = b(function() {
            c && k === d && (k = d());
      ...
      a.r = function(b) {
        function d() {
          if (0 < arguments.length)
            return (
              d.Wa(c, arguments[0]) && (d.X(), (c = arguments[0]), d.W()), this
            );
          a.k.Ob(d);
          return c;
        }
      ...
      a.Da = function(b) {
        return ("function" == typeof b && b[H] === a.r) ||
          ("function" == typeof b && b[H] === a.j && b.qc)
          ? !0
          : !1;
      };
      a.b("observable", a.r);
      ...
      a.ba.fn = {
        remove: function(b) {
          for (
            ...
            var k = d[f];
            e(k) &&
              (0 === c.length && this.X(), c.push(k), d.splice(f, 1), f--);
          }
          c.length && this.W();
          return c;
        },
      ...
      a.a.o("pop push reverse shift sort splice unshift".split(" "), function(
        b
      ) {
        a.ba.fn[b] = function() {
          var a = this.B();
            ...
            if (c && !k) {
              ...
              switch (d) {
                ...
                case "splice":
                  ...
                  for (
                    var r = 1 === v ? r : Math.min(d + (f[1] || 0), r),
                      v = d + v - 2,
                      t = Math.max(r, v),
                      G = [],
                      A = [],
            ...
            try {
              ...
              try {
                ...
                a.k.end(),
                  m &&
                    !s &&
                    a.a.A(c, function(a, b) {
                      b.p && b.p();
                    }),
                  (r = !1);
              }
              g.Wa(n, l) &&
                (s || q(n, "beforeChange"), (n = l), s ? g.Yb() : b && q(n));
              f && q(n, "awake");
            } finally {
              v = !1;
            }
      ...
      (function() {
        ...
        function e(a, b) {
          var d = c(a, b);
          return d
            ? 0 < d.length ? d[d.length - 1].nextSibling : a.nextSibling
            : null;
        }
        ...
        a.e = {
          ...
          firstChild: function(a) {
            return b(a)
              ? !a.nextSibling || d(a.nextSibling) ? null : a.nextSibling
              : a.firstChild;
          },
      ...
      (function() {
        ...
        a.a.extend(a.L.prototype, {
          ...
          getBindingAccessors: function(b, d) {
            var c = this.getBindingsString(b, d),
              c = c
                ? this.parseBindingsString(c, d, b, { valueAccessors: !0 })
                : null;
          ...
          init: function(f, k, h, l, g) {
            ...
            a.w(
              function() {
                ...
                "string" === typeof l
                  ? (h = l)
                  : ((h = a.a.c(l.name)), (t = a.a.c(l.params)));
          ...
          init: function(b, d, c) {
            function e() {
              ...
              if (!a.Z.Ca() && (!l || e)) {
                ...
                g
                  ? m !== f
                    ? (e && (a.a.ga(h, f, !0), a.a.ga(h, m, !1)), (m = f))
                    : a.a.ga(h, f, e)
            ...
            var k = a.Nb(function() {
                return c.has("checkedValue")
                  ...
                  : c.has("value") ? a.a.c(c.get("value")) : b.value;
              }),
              h = "checkbox" == b.type,
              l = "radio" == b.type;
            if (h || l) {
      ...
      a.d.options = {
        ...
        update: function(b, d, c) {
          ...
          a.a.fb(
            ...
            function(d, e, g) {
              g.length &&
                ((n = !m && g[0].selected ? [a.i.s(g[0])] : []), (r = !0));
              e = b.ownerDocument.createElement("option");
              d === L
                ? (a.a.Ha(e, c.get("optionsCaption")), a.i.Y(e, p))
                : ((g = f(d, c.get("optionsValue"), d)),
                  a.i.Y(e, a.a.c(g)),
            ...
            m
              ...
              : (h
                  ...
                  : n.length && 0 <= b.selectedIndex
                    ...
                    : n.length || 0 <= b.selectedIndex) && a.a.qa(b, "change");
          });
          a.a.kc(b);
        ...
        if (10 > a.a.M)
          var k = a.a.f.I(),
            ...
            g = function(b, c) {
              ...
              a.a.f.get(d, k) ||
                (a.a.f.set(d, k, !0), a.a.n(d, "selectionchange", l));
              a.a.f.set(b, h, c);
            };
        a.d.textInput = {
          init: function(b, c, l) {
            ...
            10 > a.a.M
              ? (h("propertychange", function(a) {
                ...
                8 == a.a.M && (h("keyup", t), h("keydown", t)),
                8 <= a.a.M && (g(b, t), h("dragend", v)))
              : (h("input", t),
                5 > e && "textarea" === a.a.v(b)
      ...
      a.J.prototype.isTemplateRewritten = function(a, d) {
        return !1 === this.allowTemplateRewriting
          ? !0
          : this.makeTemplateSource(a, d).data("isRewritten");
      };
        ...
        a.d.template = {
          ...
          update: function(b, c, d, e, f) {
            ...
            "foreach" in c
              ...
              : d
                ? ((f = "data" in c ? f.createChildContext(r, c.as) : f),
                  (e = a.eb(k || b, f, c, b)))
                : a.e.ma(b);
            f = e;
      ...
      a.a.Ma = (function() {
        function b(b, c, e, f, k) {
          ...
          for (m = 0; m <= p; m++)
            for (
              u = t, g.push((t = [])), w = h(n, m + r), q = l(0, m - 1);
              q <= w;
              q++
            )
              t[q] = q
          ...
          for (q = n; m || q; )
            (n = g[m][q] - 1),
              q && n === g[m][q - 1]
                ...
                : m && n === g[m - 1][q]
                  ? r.push(
                      (h[h.length] = { status: f, value: b[--m], index: m })
                    )
                  : (--q,
                    --m,
                    k.sparse ||
        ...
        return function(a, c, e) {
          ...
          return a.length <= c.length
            ? b(a, c, "added", "deleted", e)
            : b(c, a, "deleted", "added", e);
        };
      })();
