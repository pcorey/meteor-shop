...
(function() {
  ...
  function b(a, b) {
    ...
    if ("object" != typeof b)
      throw Error(
        "A Showdown Extension must be an object, " + typeof b + " given"
      );
    if (!d.helper.isString(b.type))
      throw Error(
        'When registering a showdown extension, "type" must be a string, ' +
          typeof b.type +
          " given"
      );
  ...
  var d = {},
    e = {},
    f = {},
    g = { omitExtraWLInCodeBlocks: !1, prefixHeaderId: !1 };
  (d.helper = {}),
    (d.extensions = {}),
    ...
    (d.Converter = function(a) {
      ...
      function b(a) {
        ...
        (a = a.replace(/~/g, "~T")),
          ...
          (a = "\n\n" + a + "\n\n"),
          (a = e.detab(a, c, b)),
          (a = e.stripBlankLines(a, c, b)),
          (a = e.languageExtensions(a, c, b));
        ...
        return (
          (a = a.replace(/~D/g, "$$")),
          (a = a.replace(/~T/g, "~")),
          d.helper.forEach(b.outputModifiers, function(b) {
            a = d.subParser("runExtension")(b, a);
          }),
          (a = e.outputModifiers(a, c, b))
        );
      }
      a = a || {};
      var c = g,
      ...
      if ("object" == typeof a)
        for (var k in a) a.hasOwnProperty(k) && (c[k] = a[k]);
      var l = this;
      return (
        (l.makeHtml = b),
        c.extensions &&
          d.helper.forEach(c.extensions, function(a) {
            var b = a;
            if ("string" == typeof a) {
              var c = d.helper.stdExtName(a);
              !d.helper.isUndefined(d.extensions[c]) && d.extensions[c]
                ? (a = d.extensions[c])
                : d.helper.isUndefined(f[c]) || (a = f[c]);
            }
            if ("function" != typeof a) {
              var e =
                "An extension could not be loaded. It was either not found or is not a valid extension.";
              throw ("string" == typeof b &&
                (e =
                  'Extension "' +
                  b +
            ...
            d.helper.forEach(a(l), function(a) {
              a.type
                ? "language" === a.type || "lang" === a.type
                  ? h.push(a)
                  : ("output" === a.type || "html" === a.type) && i.push(a)
                : i.push(a);
            });
          }),
        { makeHtml: b }
    ...
    d.subParser("codeSpans", function(a) {
      "use strict";
      return (a = a.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, function(
        a,
        b,
        c,
        e
      ...
      return (
        ...
        (a = a.replace(/(?:^|\n)```(.*)\n([\s\S]*?)\n```/g, function(a, e, f) {
          ...
          return (
            ...
            (h = d.subParser("encodeCode")(h)),
            (h = d.subParser("detab")(h)),
            (h = h.replace(/^\n+/g, "")),
            (h = h.replace(/\n+$/g, "")),
            (h =
              "<pre><code" +
    ...
    d.subParser("hashHTMLBlocks", function(a, b, c) {
      ...
      return (
        ...
        (a = a.replace(
          /^(<(p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math|style|section|header|footer|nav|article|aside|address|audio|canvas|figure|hgroup|output|video)\b[^\r]*?<\/\2>[ \t]*(?=\n+)\n)/gm,
          d.subParser("hashElement")(a, b, c)
        )),
        (a = a.replace(
          /(\n[ ]{0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g,
    ...
    d.subParser("languageExtensions", function(a, b, c) {
      "use strict";
      return (
        d.helper.forEach(c.langExtensions, function(b) {
          a = d.subParser("runExtension")(b, a);
        }),
        a
      );
    ...
    d.subParser("lists", function(a, b, c) {
        ...
        return (
          ...
          (a = a.replace(
            ...
            function(a, e, f, g, h) {
              ...
              return (
                e || i.search(/\n{2,}/) > -1
                  ? (i = d.subParser("blockGamut")(i, b, c))
                  : ((i = d.subParser("lists")(i, b, c)),
                    (i = i.replace(/\n$/, "")),
      ...
      return (
        c.gListLevel
          ...
          : ((f = /(\n\n|^\n?)(([ ]{0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(~0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/g),
            (a = a.replace(f, function(a, b, c, d) {
              var f = c.replace(/\n{2,}/g, "\n\n\n"),
    ...
    d.subParser("outputModifiers", function(a, b, c) {
      "use strict";
      return (
        d.helper.forEach(c.outputModifiers, function(b) {
          a = d.subParser("runExtension")(b, a);
        }),
        a
      );
    ...
    d.subParser("stripLinkDefinitions", function(a, b, c) {
      ...
      return (
        (a += "~0"),
        (a = a.replace(e, function(a, b, e, f, g) {
          return (
            (b = b.toLowerCase()),
            (c.gUrls[b] = d.subParser("encodeAmpsAndAngles")(e)),
            f ? f + g : (g && (c.gTitles[b] = g.replace(/"/g, "&quot;")), "")
          );
        })),
        (a = a.replace(/~0/, ""))
      );
